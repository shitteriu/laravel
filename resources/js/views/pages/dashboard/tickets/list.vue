                                                    ...
                                                    <div class="flex items-start justify-between space-x-3">
                                                        ...
                                                        <div class="h-7 flex items-center">
                                                            <button aria-label="Close panel" class="text-gray-400 hover:text-gray-500 transition ease-in-out duration-150" type="button" @click="closeFiltersSidebar">
                                                                <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg">
        ...
        <div class="tickets-list">
            <div class="hidden sm:block">
                <div v-show="selectedRows.length > 0" v-on-clickaway="closeQuickActionDropdown" class="tickets-list-toolbar">
                    ...
                    <div class="relative inline-block text-left">
                        <button class="btn hover:bg-gray-100 p-4 border-r border-gray-200 rounded-none" type="button" @click="toggleQuickActionDropdown('status')">
                            <svg-vue class="h-6 w-6 text-gray-700" icon="font-awesome.tasks-regular"></svg-vue>
                        </button>
                        <div v-show="quickActions.status" class="origin-top-right absolute left-0 mt-1 w-56 rounded-md shadow-lg">
                            <div class="rounded-md bg-white shadow-xs">
                                <div class="py-1">
                                    <template v-for="status in statusList">
                                        <a
                                            ...
                                            href="#"
                                            role="menuitem"
                                            @click.prevent="quickAction('status', status.id)"
                                        >
                                            {{ status.name }}
                                        </a>
                                    </template>
...
export default {
    ...
    methods: {
        ...
        closeQuickActionDropdown() {
            ...
            this.quickActions.status = false;
        ...
        toggleQuickActionDropdown(quickAction) {
            ...
            if (quickAction === 'status') {
                this.quickActions.status = !this.quickActions.status;
                this.quickActions.agent = false;
                this.quickActions.department = false;
                this.quickActions.label = false;
                this.quickActions.priority = false;
