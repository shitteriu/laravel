                    ...
                    <div class="sm:flex sm:justify-between">
                        <div class="flex">
                            ...
                            <div v-on-clickaway="closeActionDropdown" class="block">
                                ...
                                <div class="relative inline-block text-left">
                                    <button class="btn p-4 rounded-none" type="button" @click="toggleActionDropdown('status')">
                                        <svg-vue class="h-5 w-5 text-gray-700" icon="font-awesome.tasks-regular"></svg-vue>
                                    </button>
                                    <div v-show="actions.status" class="origin-top-right absolute left-0 mt-1 w-56 rounded-md shadow-lg z-20">
                                        <div class="rounded-md bg-white shadow-xs">
                                            <div class="py-1">
                                                <template v-for="status in statusList">
                                                    <a
                                                        ...
                                                        href="#"
                                                        role="menuitem"
                                                        @click.prevent="action('status', status.id)"
                                                    >
                                                        {{ status.name }}
                                                    </a>
                                                </template>
...
export default {
    ...
    methods: {
        ...
        toggleActionDropdown(action) {
            ...
            if (action === 'status') {
                this.actions.status = !this.actions.status;
                this.actions.agent = false;
                this.actions.department = false;
                this.actions.label = false;
                this.actions.priority = false;
